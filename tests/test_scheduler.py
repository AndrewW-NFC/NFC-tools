...
from nfc_tools.scheduler import compute_window, normalize_evening_start, session_date_for
...
def test_window_with_invalid_timezone_falls_back_to_input_style():
	w = compute_window(datetime(2026, 5, 10, 21, 0), "21:00", "06:15", "Invalid/Timezone")
	assert w.starts_at == datetime(2026, 5, 10, 21, 0)
	assert w.ends_at == datetime(2026, 5, 11, 6, 15)


def test_normalizes_morning_looking_evening_start():
